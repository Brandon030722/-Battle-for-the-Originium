...
faction_cards = {
    1: {  # 罗德岛分支
        1: ("Amiya", 2, 1, 2, "D:\\qt_p\\agent"),
        2: ("Kal'tsit", 3, 2, 4, "D:\\qt_p\\agent"),
        3: ("Warfarin", 1, 1, 2, "D:\\qt_p\\agent"),
        4: ("Mudrock", 2, 1, 4, "D:\\qt_p\\agent"),
        5: ("Eyjafjalla", 3, 1, 4, "D:\\qt_p\\agent"),
        6: ("Blaze", 2, 1, 5, "D:\\qt_p\\agent"),
        7: ("W", 3, 2, 3, "D:\\qt_p\\agent"),
        8: ("Kroos", 1, 1, 2, "D:\\qt_p\\agent")
    },
    2: {  # 卡西米尔分支
        1: ("Nearl", 3, 3, 1, "D:\\qt_p\\agent"),
        2: ("Blemishine", 3, 1, 3, "D:\\qt_p\\agent"),
        3: ("Mlynar", 4, 1, 1, "D:\\qt_p\\agent"),
        4: ("Gravel", 1, 1, 3, "D:\\qt_p\\agent"),
        5: ("Flametail", 2, 2, 3, "D:\\qt_p\\agent"),
        6: ("Whislash", 1, 2, 2, "D:\\qt_p\\agent"),
        7: ("Fartooth", 2, 3, 1, "D:\\qt_p\\agent"),
        8: ("Platinum", 1, 1, 2, "D:\\qt_p\\agent")
    },
    3: {  # 大炎分支
        1: ("Ch'en", 3, 2, 4, "D:\\qt_p\\agent"),
        2: ("Hoshiguma", 1, 1, 5, "D:\\qt_p\\agent"),
        3: ("Swire", 1, 1, 2, "D:\\qt_p\\agent"),
        4: ("Shu", 3, 1, 7, "D:\\qt_p\\agent"),
        5: ("Nian", 2, 2, 3, "D:\\qt_p\\agent"),
        6: ("Ling", 2, 1, 1, "D:\\qt_p\\agent"),
        7: ("Chongyue", 3, 3, 3, "D:\\qt_p\\agent"),
        8: ("Dusk", 1, 1, 2, "D:\\qt_p\\agent")
    },
    4: {  # Deep Sea Faction
        1: ("Skadi (Corrupt Heart)", 1, 2, 8, "D:\\qt_p\\agent"),
        2: ("Specter", 5, 4, 6, "D:\\qt_p\\agent"),
        3: ("Gladiia", 3, 1, 4, "D:\\qt_p\\agent"),
        4: ("Deepcolor", 1, 1, 2, "D:\\qt_p\\agent"),
        5: ("Andreana", 1, 1, 1, "D:\\qt_p\\agent"),
        6: ("Seawatch", 1, 1, 2, "D:\\qt_p\\agent"),
        7: ("Thorns", 2, 2, 3, "D:\\qt_p\\agent"),
        8: ("Elysium", 3, 2, 5, "D:\\qt_p\\agent")
    },
    5: {  # Laterno Faction
        1: ("Mostima", 5, 4, 6, "D:\\qt_p\\agent"),
        2: ("Exusiai", 2, 2, 4, "D:\\qt_p\\agent"),
        3: ("Fiammetta", 2, 2, 6, "D:\\qt_p\\agent"),
        4: ("Executor", 3, 3, 5, "D:\\qt_p\\agent"),
        5: ("Sussurro", 3, 2, 6, "D:\\qt_p\\agent"),
        6: ("Aak", 1, 1, 2, "D:\\qt_p\\agent"),
        7: ("Beeswax", 2, 1, 3, "D:\\qt_p\\agent"),
        8: ("Scene", 1, 2, 2, "D:\\qt_p\\agent")
    }
}
...
class CardGameGUI(tk.Tk):
    ...
    def show_card_on_ally_deployment(self, img_path, card_name):
            ...
            img = img.resize((100, 180), Image.ANTIALIAS)
            photo_img = ImageTk.PhotoImage(img)
            self.card_images.append(photo_img)  # Store reference to avoid garbage collection
            canvas = self.ally_deployment_frame
            num_cards = len(self.card_images) - 1  # Number of cards already deployed
            canvas.create_image(10 + 110 * num_cards, 10, image=photo_img, anchor=tk.NW)
