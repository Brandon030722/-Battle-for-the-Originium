...
faction_cards = {
    1: {  # 罗德岛分支
        1: ("Amiya", 2, 1, 2, "./Battle for the originium\\Luodedao\\Amiya.png"),
        2: ("Kal'tsit", 3, 2, 4, "./Battle for the originium\\Luodedao\\Kal'tsit.png"),
        3: ("Warfarin", 1, 1, 2, "./Battle for the originium\\Luodedao\\Warfarin.png"),
        4: ("Mudrock", 2, 1, 4, "./Battle for the originium\\Luodedao\\Mudrock.png"),
        5: ("Eyjafjalla", 3, 1, 4, "./Battle for the originium\\Luodedao\\Eyjafjalla.png"),
        6: ("Blaze", 2, 1, 5, "./Battle for the originium\\Luodedao\\Blaze.png"),
        7: ("W", 3, 2, 3, "./Battle for the originium\\Luodedao\\W.png"),
        8: ("Kroos", 1, 1, 2, "./Battle for the originium\\Luodedao\\Kroos.png")
    },
    2: {  # 卡西米尔分支
        1: ("Nearl", 3, 3, 1, "./Battle for the originium\\Kaximier\\Nearl.png"),
        2: ("Blemishine", 3, 1, 3, "./Battle for the originium\\Kaximier\\Blemishine.png"),
        3: ("Mlynar", 4, 1, 1, "./Battle for the originium\\Kaximier\\Mlynar.png"),
        4: ("Gravel", 1, 1, 3, "./Battle for the originium\\Kaximier\\Gravel.png"),
        5: ("Flametail", 2, 2, 3, "./Battle for the originium\\Kaximier\\Flametail.png"),
        6: ("Whislash", 1, 2, 2, "./Battle for the originium\\Kaximier\\Whislash.png"),
        7: ("Fartooth", 2, 3, 1, "./Battle for the originium\\Kaximier\\Fartooth.png"),
        8: ("Platinum", 1, 1, 2, "./Battle for the originium\\Kaximier\\Platinum.png")
    },
    3: {  # 大炎分支
        1: ("Ch'en", 3, 2, 4, "./Battle for the originium\\Dayan\\chen.png"),
        2: ("Hoshiguma", 1, 1, 5, "./Battle for the originium\\Dayan\\Hoshiguma.png"),
        3: ("Swire", 1, 1, 2, "./Battle for the originium\\Dayan\\Swire.png"),
        4: ("Shu", 3, 1, 7, "./Battle for the originium\\Dayan\\shu.png"),
        5: ("Nian", 2, 2, 3, "./Battle for the originium\\Dayan\\nian.png"),
        6: ("Ling", 2, 1, 1, "./Battle for the originium\\Dayan\\ling.png"),
        7: ("Chongyue", 3, 3, 3, "./Battle for the originium\\Dayan\\chongyue.png"),
        8: ("Dusk", 1, 1, 2, "./Battle for the originium\\Dayan\\Dusk.png")
    },
    4: {  # Deep Sea Faction
        1: ("Skadi", 1, 1, 3, "./Battle for the originium\\Shenhailieren\\Skadi.png"),
        2: ("Specter", 3, 3, 3, "./Battle for the originium\\Shenhailieren\\Specter.png"),
        3: ("Gladiia", 3, 1, 4, "./Battle for the originium\\Shenhailieren\\Gladiia.png"),
        4: ("Deepcolor", 1, 1, 2, "./Battle for the originium\\Shenhailieren\\Deepcolor.png"),
        5: ("Andreana", 1, 1, 1, "./Battle for the originium\\Shenhailieren\\Andreana.png"),
        6: ("Highmore", 1, 1, 2, "./Battle for the originium\\Shenhailieren\\Highmore.png"),
        7: ("Thorns", 2, 2, 3, "./Battle for the originium\\Shenhailieren\\Thorns.png"),
        8: ("irene", 3, 2, 5, "./Battle for the originium\\Shenhailieren\\irene.png")
    },

    5: {  # Laterno Faction
        1: ("Mostima", 5, 4, 6, "./Battle for the originium\\Latelan\\Mostima.png"),
        2: ("Executor", 2, 2, 4, "./Battle for the originium\\Latelan\\Executor.png"),
        3: ("Fiammetta", 2, 2, 6, "./Battle for the originium\\Latelan\\Fiammetta.png"),
        4: ("Executor", 3, 3, 5, "./Battle for the originium\\Latelan\\Executor.png"),
        5: ("Virtuosa", 3, 2, 6, "./Battle for the originium\\Latelan\\Virtuosa.png"),
        6: ("Archetto", 1, 1, 2, "./Battle for the originium\\Latelan\\Archetto.png"),
        7: ("Spuria", 2, 1, 3, "./Battle for the originium\\Latelan\\Spuria.png"),
        8: ("insider", 1, 2, 2, "./Battle for the originium\\Latelan\\insider.png")
    }
}
...
#存储和加载游戏状态
    ...
    def load_background_images(self):
        # 加载所有背景图片
        self.enemy_bg_image = ImageTk.PhotoImage(Image.open("./Background\\1.jpg"))
        self.frontline_bg_image = ImageTk.PhotoImage(Image.open("./Background\\3.jpg"))
        self.ally_bg_image = ImageTk.PhotoImage(Image.open("./Background\\2.jpg"))
        self.button_bg_image = ImageTk.PhotoImage(Image.open("./Background\\1111.jpg"))

    def popup_image(self , image_path):
        # 创建一个新的顶级窗口
        popup = Toplevel()
        popup.title("Image Popup")

        # 加载图片并使用PIL转换为可用的Tkinter格式
    ...
    def attack_base(self):
        ...
        if choice and (choice - 1 not in self.attacked_this_turn):
            ...
            if Base1_hp <= 0 or Base2_hp <= 0:
                ...
                pygame.init()
                pygame.mixer.init()  # 初始化音频组件
                pygame.mixer.music.load('./music\\Overcoming Fear.mp3')
                pygame.mixer.music.play(-1)
                messagebox.showinfo("Game Over", "A base has been destroyed! \nYou win!\n Game over.")
                self.popup_image('./victories.png')
                sys.exit()
        else:
...
if __name__ == '__main__':
    ...
    pygame.init()
    pygame.mixer.init()  # 初始化音频组件
    pygame.mixer.music.load('./music\\The Boat of Tomorrow.mp3')  # 加载音乐文件
